...
// I2C Addresses
#define MAX30101_WRITE_ADDRESS  0xAE >> 1 //Scod: ho invertito AF e AE che li avevamo confusi
#define MAX3010_READ_ADDRESS    0xAF >> 1 // 0xAE >> 1 and 0xAF >> 1 are the same address
